...
public enum ErrorCode {
    ...
    INVALID_PASSWORD(HttpStatus.UNAUTHORIZED, "INVALID_PASSWORD", "일치하지 않는 비밀번호"),
    ...
    INVALID_NICKNAME_FORMAT(HttpStatus.BAD_REQUEST, "INVALID_NICKNAME_FORMAT", "별명은 영문 소문자 시작, 숫자와 '_'만 가능하며 3~20자여야 합니다."),
    ...
    COMMENT_NOT_IN_POST(HttpStatus.NOT_FOUND,"COMMENT_NOT_IN_POST", "댓글이 해당 게시글에 있지 않습니다."),
